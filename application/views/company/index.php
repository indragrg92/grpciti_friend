          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('company/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="vat_charge_value">Tax Charge (%)</label>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="address" name="address" placeholder="Enter address" autocomplete="off"><?php echo $company_data['address'] ?></textarea>
                </div>
                <div class="form-group">
