          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">Select Customer</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-5 col-sm-7">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" id="save_customer_data" name="save_customer_data"> Save customer data
                        </label>
                      </div>
                    </div>
                  </div>
                   ...
                   <tbody>
                     <tr id="row_1" data-id="1">
                       ...
                       <td>
                        ...
                        <td>
                          <input type="text" name="rate[]" id="rate_1" class="form-control" disabled autocomplete="off" required>
                          <input type="hidden" name="rate_value[]" id="rate_value_1" class="form-control" autocomplete="off" required>
                        </td>
                        <td>
                          <input type="text" name="amount[]" id="amount_1" class="form-control" disabled autocomplete="off" required>
                          <input type="hidden" name="amount_value[]" id="amount_value_1" class="form-control" autocomplete="off" required>
                        </td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">Tax <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
...
<script type="text/javascript">
  ...
  $(document).on( 'change', '#select-customer', function( e ) {
    ...
    $.ajax({
      url: '<?php echo base_url( 'customers/fetchCustomerByID/' ) ?>'+id,
      type: 'post',
      dataType: 'json',
  ...
  $(document).ready(function() {
    ...
    $("#add_row").unbind('click').bind('click', function() {
      ...
      var row_id = $("#product_info_table tbody tr:last").data( 'id' );
      ...
      $.ajax({
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'" data-id="'+row_id+'">'+
                   '<td></td>'+
                   '<td>'+ 
              ...
              $.each( $("#product_info_table tbody tr"), function( i, v ) {
                var row_num = i + 1;
                $(v).find("td:first-child").html( row_num );
              } );
